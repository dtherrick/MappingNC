...
countiesFile = master_path + 'SourceData/NorthCarolinaCountiesByFIPS.svg'
dataFile = master_path + 'SourceData/2009_PrenatalCareStartsInThirdTriFIPS.txt'
diagsFilePath = master_path + 'Output/ThirdTrimesterCare/Diags_PrenatalCareStartsInThirdTri.txt'
...
diagsFile = open(diagsFilePath, 'w')
