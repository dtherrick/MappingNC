...
dataFile = master_path + 'SourceData/2009VeryLowBirthWeightAllFIPS.txt'
diagsFilePath = master_path + 'Output/VeryLowBirthWeight/Diags_2009VeryLowBirthWeightAll.txt'
