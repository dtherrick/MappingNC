...
reader = csv.reader(open('NCPopulationFemale18-24.csv', 'r'), delimiter=",")
...
for row in reader:
    ...
    min_pop = rates_only[0]
    max_popIndex = int(len(rates_only)) - 1
    max_pop = rates_only[max_popIndex]
...
diagsFile = open('Diags_PopulationFemale18to24.txt', 'w')
